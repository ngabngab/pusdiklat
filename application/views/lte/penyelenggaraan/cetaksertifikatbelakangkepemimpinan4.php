...
<table style="width:100%;margin-top:20px;">
	...
	<tr>
		<td style="font-size: 12pt;padding:3px 3px 3px 20px;vertical-align: top;"><span style="font-style: italic;">Coaching</span> dan <span style="font-style: italic;">Counseling</span></td>
		<td style="font-size: 12pt;padding:3px 3px 3px 20px;">1. Seminar Laboratorium Kepemimpinan<br>2. Seminar Laboratorium Kepemimpinan</td>
	</tr>
	<tr>
		...
		<td style="font-size: 12pt;padding:3px 3px 3px 20px;"></td>
	</tr>
	<tr>
		<td style="font-size: 12pt;padding:3px 3px 3px 20px;">1. Kecerdasan Emosional</td>
		<td style="font-size: 12pt;padding:3px 3px 3px 3px;text-align:center;">Bogor, <?php echo $tglEnd;?></td>
	</tr>
	<tr>
		<td style="font-size: 12pt;padding:3px 3px 3px 20px;">2. Membangun Tim Efektif</td>
		<td style="font-size: 12pt;padding:3px 3px 3px 3px;text-align:center;"><?php echo $namaJabatan;?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="font-size: 12pt;padding:3px 3px 3px 3px;text-align:center;"><?php echo $namaKapus;?></td>
	</tr>
	<tr>
		<td style="font-size: 12pt;padding:3px 3px 3px 3px;text-align:center;"></td>
		<td style="font-size: 12pt;padding:3px 3px 3px 3px;text-align:center;">NIP <?php echo $nipKapus;?></td>
	</tr>
</table>
</body>
</html>
