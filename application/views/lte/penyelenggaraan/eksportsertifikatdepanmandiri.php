...
header("Content-Disposition: attachment;Filename=sertifikat_mandiri_depan.doc");
...
$html .= '<table style="width:100%">
	<tr>
		...
		<td style="text-align: right;"><img src="http://localhost/simdiklat5/assets/imgupload/'.$filenameMandiri.'"></td>
	</tr>
</table>
<table style="width:100%;">
	...
	<tr>
		<td style="font-size: 12pt;text-align:center;font-family: maiandra;">Nomor: SERT-'.$peserta->nomorSertifikat.'/DL/'.$bidangID.'/'.$year.'</td>
	</tr>
</table>
	...
	<tr>
		...
		<td>
			<table style="width:100%;font-family:maiandra;">
				<tr>
					<td style="font-size: 12pt;text-align:left;width:180px;">'.$txtNIP.'</td>
					<td style="font-size: 12pt;text-align:center;width:30px;">:</td>
					<td style="font-size: 12pt;text-align:left;">'.$pesertaNIP.'</td>
				</tr>
				<tr>
					
					<td style="font-size: 12pt;text-align:left;width:180px;">'.$txtPangkat.'</td>
					<td style="font-size: 12pt;text-align:center;width:30px;">:</td>
					<td style="font-size: 12pt;text-align:left;">'.$pesertaPangkat.'</td>
				</tr>
				<tr>';
					...
					$html .= '<td style="font-size: 12pt;text-align:left;width:180px;">Jabatan</td>
					<td style="font-size: 12pt;text-align:center;width:30px;">:</td>
					<td style="font-size: 12pt;text-align:left;">'.$pesertaJabatan.'</td>
				</tr>
				<tr>';
					...
					$html .= '<td style="font-size: 12pt;text-align:left;width:180px;">Unit Organisasi</td>
					<td style="font-size: 12pt;text-align:center;width:30px;">:</td>
					<td style="font-size: 12pt;text-align:left;">'.$pesertaUnit.'</td>
				</tr>
			</table>
		</td>
	</tr>
...
<table style="width:100%;">
	...
	<tr>
		<td style="font-size: 16pt;text-align:center;font-family: maiandrabold;">'.$diklatName.'</td>
	</tr>
	<tr>
		<td style="font-size: 12pt;text-align:center;font-family: maiandra;">'.$sumJP.' Jam Pelatihan</td>
	</tr>
	<tr>
		<td style="font-size: 12pt;text-align:center;font-family: maiandra;">'.$diklatLocName.', '.$tglStart.' - '.$tglEnd.'</td>
	</tr>
</table>
...
<table style="width:100%;">
	<tr>
		<td style="text-align: center;">
			<div style="font-family: maiandrabold;font-size: 12pt;">'.$namaJabatan.',</div>
			<br>
			<br>
			<div style="font-family: maiandrabold;font-size: 12pt;">'.$namaKapus.'</div>
			<div style="font-family: maiandra;font-size: 12pt;">NIP '.$nipKapus.'</div>
		</td>	
		<td style="text-align: center;">
			<div style="font-family: maiandrabold;font-size: 12pt;">'.$jabatanMandiri.'</div>
			<br>
			<br>
			<div style="font-family: maiandrabold;font-size: 12pt;">'.$namaMandiri.'</div>
			<div style="font-family: maiandra;font-size: 12pt;">NIP '.$nipMandiri.'</div>
		</td>
	</tr>
</table>';
