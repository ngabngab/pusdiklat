...
@font-face {
    font-family: trebuc;
    src: url(D:\xampp\htdocs\simdiklat5\assets\fonts\trebuc.ttf);
}

@font-face {
    font-family: trebucbd;
    src: url(D:\xampp\htdocs\simdiklat5\assets\fonts\trebucbd.ttf);
}


@font-face {
    font-family: monotype;
    src: url(D:\xampp\htdocs\simdiklat5\assets\fonts\MTCORSVA.ttf);
}


@font-face {
    font-family: maiandra;
    src: url(D:\xampp\htdocs\simdiklat5\assets\fonts\MAIAN.ttf);
}


@font-face {
    font-family: maiandrabold;
    src: url(D:\xampp\htdocs\simdiklat5\assets\fonts\maiandrabold.ttf);
}
...
<table style="width: 100%;margin-top: 20px;">
	<tr>
		<td style="text-align:center;font-size:12pt;padding-left: 300px;font-family: maiandra;"><?php echo $diklatLocName;?>, <?php echo $tglEnd;?></td>
	</tr>
	<tr>
		<td style="text-align:center;font-size:12pt;padding-left: 300px;font-family: maiandra;"><?php echo $namaJabatan;?></td>
	</tr>
	<tr>
		<td style="text-align:center;font-size:12pt;padding-left: 300px;padding-top:50px;font-family: maiandra;"><?php echo $namaKapus;?></td>
	</tr>
	<tr>
		<td style="text-align:center;font-size:12pt;padding-left: 300px;font-family: maiandra;">NIP <?php echo $nipKapus;?></td>
	</tr>
</table>
</body>
</html>
