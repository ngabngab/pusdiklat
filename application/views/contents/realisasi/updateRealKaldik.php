            ...
            <div class="container-fluid">
                ...
                <?php 
                    ...
                    <div class="col-lg-6">
                        ...
                        <img src="<?= base_url()?>/assets/img/line.png" style="width: 100%;"/>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kaldikCode1" readonly="true" placeholder="Enter Kode Kaldik" value="<?php echo $id_kaldik; ?>">
                            </div>
                            <div class="form-group">
                    ...
                    <h4><i class="fa fa-check-square-o"></i> Realisasi Diklat</h4>
                        ...
                        <div class="form-group">
                                <label>Jumlah Hari</label>
                                <input class="form-control" type="number" id="hari" name="hari" placeholder="Hari" value="<?php echo $Realkaldik[0]->hari; ?>" readonly="true" style="width: 100px;">
                            </div>    
