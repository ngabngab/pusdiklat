...
var total = [];
var selisihKelas = [];
var arrSplit, diklatlocid, diklatlocname, biayaid, biayaname, jadwalid, mataajarname, mataajarid, tanggal, pegawaiid, pegawainame, kaldikid, kelasid, bulan, tahun, pengajarid, jmlhari, kaldikname, backgroundcolor, trid, backgroundcolortr, nomorst, tanggalst;
trid = '';
backgroundcolortr = '';
var tab;
...
{
	var uri = '<?php echo base_url(); ?>' + 'jadwal/pindahjadwal/' + idJadwalBefore+'/'+idJadwalAfter;
	console.log(uri);
	$.ajax({
		type: 'get',
		url: uri,
...
function simpanDataPengajar()
{
	...
	{
		jmlhari = document.getElementById('jmlHariAvailable').value;
		var uri = '<?php echo base_url(); ?>' + 'jadwal/tambahpengajar/'+jadwalid+'/'+pegawai[0].pegawaiid+'/'+jmlhari+'/'+kelasid;
		  ...
		  <div id="tableJadwalContainer" style="display:none;">
            ...
            <div class="box-header">
              ...
              <div class="box-tools pull-right">
				<button type="button" class="btn btn-primary btn-sm pull-right" data-widget="collapse" data-toggle="tooltip" title="Collapse" style="margin-right: 5px;">
                  <i class="fa fa-minus"></i></button>
				  <button type="button" class="btn btn-primary btn-sm pull-right" style="margin-right: 5px;" onclick="cetakJadwal();"><i class="fa fa-print"></i> Print Jadwal</button>
