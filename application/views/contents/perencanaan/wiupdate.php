...
?>
				...
				function remLink() {
					if (window.sList && window.sList.open && !window.sList.closed){
                        ...
                        window.location.replace('<?php echo base_url();?>index.php/wi/index/'+$('#diklatID').val());
                    }
				}
		...
		<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
						...
						echo form_open('wi/updateAct/', $attributes); ?>
                            <label>Kaldik Code</label>
							<div class="form-group input-group">
								<input class="form-control" type="hidden" id="kaldikID" name="kaldikID" value="<?php echo $kaldikIDup;?>">
								<input class="form-control" type="hidden" id="wiAssignmentID" name="wiAssignmentID" value="<?php echo $wiAssignmentID;?>">
							...
							<div class="form-group input-group">
                                <input class="form-control" type="hidden" id="instructorID" name="wiID" readonly value="<?php echo $pegawaiIDup;?>">
								<input class="form-control" type="text" id="instructorName" name="wiName" readonly value="<?php echo $pegawaiNameup;?>">
                        ...
                        <hr>
                            ...
                            <label>Rencana Tanggal Mata Ajar</label>
                            <div class="form-group">
								<input class="form-control" type="text" id="rencanaTgl" name="rencanaTgl" value="">
							</div>
                            <div class="form-group">
...
<!--                                <input type="text" class="form-control" style="width:auto; display:inline;" name="endTime" size="6">-->
                ...
                <div class="row">
					...
					<div class="col-lg-12">
                        <h3>Data Rencana Penugasan Wi</h3>
