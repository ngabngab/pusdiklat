...
function onTampil()
{
	...
	{
		uri = '<?php echo base_url();?>kaldikrealisasi?month='+bulan+'&year='+tahun+'&diklatlocid='+loc[0].diklatlocid+'&biayaid='+biaya[0].biayaid;
	}
	else if (loc.length > 0)
	{
		uri = '<?php echo base_url();?>kaldikrealisasi?month='+bulan+'&year='+tahun+'&diklatlocid='+loc[0].diklatlocid;
	}
	else if (biaya.length > 0)
	{
		uri = '<?php echo base_url();?>kaldikrealisasi?month='+bulan+'&year='+tahun+'&biayaid='+biaya[0].biayaid;
	}
	else
	{
		uri = '<?php echo base_url();?>kaldikrealisasi?month='+bulan+'&year='+tahun;
	}
...
<!-- Main content -->
    <section class="content">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a onclick="refreshPage('<?php echo base_url(); ?>kaldikrealisasi');" style="cursor:pointer;"><i class="fa fa-calendar"></i> Kaldik</a></li>
		</ol>
									...
									{	
										foreach($kaldik->cal[$i] as $calen)
										{
											...
											if($calen->enddate == '1')
											{
												...
												{
													?>
													<td style="background-color:#<?php echo $kaldik->color; ?>;padding:0!important;text-align:center;"><a href="#" id="<?php echo base_url(); ?>kaldikrealisasi/viewkaldikrealisasi/<?php echo $kaldik->kaldikID; ?>/<?php echo $kaldik->startDate; ?>" onclick="viewKaldik(this.id);" data-toggle="tooltip" data-html="true" data-placement="top" title="<?php echo $calen->sesiName."<br>Kurikulum : ".$calen->kurikulumSesiDesc . "<br>Sumber Biaya : " . $kaldik->biayaName . "<br>".$statKaldik; ?>"><div style="margin:0!important;padding:0!important;width:100%;height:100%;display:inline-block;"><?php echo $kaldik->kelas; ?></div></a></td>
													<?php
												}
												else
												{
												?>
													<td style="background-color:#03A9F4;padding:0!important;text-align:center;"><a href="#" id="<?php echo base_url(); ?>kaldikrealisasi/viewkaldikrealisasi/<?php echo $kaldik->kaldikID; ?>/<?php echo $kaldik->startDate; ?>" onclick="viewKaldik(this.id);" data-toggle="tooltip" data-html="true" data-placement="top" title="<?php echo $calen->sesiName."<br>Kurikulum : ".$calen->kurikulumSesiDesc . "<br>Sumber Biaya : " . $kaldik->biayaName."<br>".$statKaldik; ?>"><div style="margin:0!important;padding:0!important;width:100%;height:100%;display:inline-block;"><?php echo $kaldik->kelas; ?></div></a></td>
												<?php
												}
											}
