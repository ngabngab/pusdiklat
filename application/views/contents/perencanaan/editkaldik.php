            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-tasks"></i>Update Perencanaan | Kaldik
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                 <div class="col-lg-12">
                    <a href="<?php echo base_url()?>index.php/Kaldik/kaldik_list"  class="btn btn-danger">Kembali</a>
                        
                        <br />
                    </div>
                    <div class="col-lg-6">
						<h3><i class="fa fa-book"></i> Data Diklat</h3>
                        <img src="<?= base_url()?>/assets/img/line.png" style="width: 100%;"/>
                        <?php 
							$attributes = array('name' => 'len','id' => 'inputform');
							echo form_open('Kaldik/edit/'.$idKaldik, $attributes); 
							...
							<input class="form-control" type="hidden" name="ownkaldikID" readonly="true" value="<?php echo $kaldik[0]->kaldikID; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="namaDiklat" name="kaldikDiklatName" readonly="true" value="<?php echo $kaldikDiklatName; ?>">
                            </div>
							
                            <div class="form-group">
                                <label>Blended Learning</label><br />
                                <input type="checkbox" name="blended" value="1" <?php if ($kaldik[0]->stat_blended != NULL){echo 'checked';}?>> Yes Blended Learning/ Tatap Muka 
                            </div>
							<div class="form-group">
                                <label>E-Learning</label><br />
                                <input type="checkbox" name="elearning" value="1" id="checkbox" <?php if ($kaldik[0]->stat_elearning != NULL){echo 'checked';}?> > Yes E-Learning  
                                <!--
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="tatapmuka" value="1" <?php if ($kaldik[0]->stat_tatapmuka != NULL){echo 'checked';}?>> Yes Tatap Muka 
                            </div>
                            <label>Lokasi</label>
                            <div class="form-group input-group">
								<input class="form-control" type="hidden" id="diklatLocID" name="kaldikLocID" readonly value="<?php echo $kaldikLocID;; ?>">
								<input class="form-control" type="text" id="diklatLocName" name="kaldikLocName" readonly value="<?php echo $kaldikLocName; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="LokasiDetail" name="LokasiDetail" readonly="true" placeholder="Enter Lokasi Detail" value="<?php echo $Loc[0]->diklatLocDetail; ?>">
                            </div>
                            <?php echo form_error('kaldikDesc', '<div class="alert alert-danger">', '</div>'); ?>
							<div class="form-group">
                                <label>Uraian Diklat</label>
                                <textarea name="kaldikDesc" class="form-control" id="uraian" rows="3"><?php echo $kaldik[0]->kaldikDesc ?></textarea>
                            </div>
                            <br />
                    ...
                    <div class="col-lg-5">
                        ...
                        <img src="<?= base_url()?>/assets/img/line.png" style="width: 100%;"/>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" id="hari"  name="hari" placeholder="Hari" value="<?php echo $kaldik[0]->hari; ?>" style="width: 100px;">
                            </div>  
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="kelas" placeholder="Kelas" min="1" value="<?php echo $kaldik[0]->kelas; ?>" style="width: 100px;"> 
                            </div>
                            <?php echo form_error('hour', '<div class="alert alert-danger">', '</div>'); ?>
                            <div class="form-group">
                                <label>Jumlah Jam</label>
                                <input class="form-control" type="number" id="hour" name="hour" placeholder="Jam" value="<?php echo $kaldik[0]->hour; ?>" style="width: 100px;">
                            </div>
