...
<div id="header">
	...
	<table>
		...
		<td style="border:2px solid #000;font-weight: bold;width:100px;text-align:center;">REVISI <?php echo $revisiNO; ?></td>
		</tr>
	</table>
...
foreach($jadwals as $jadwal)
{
		?>
			...
			if($i == 1)
			{
				...
				<tr>
				<?php 
				if((int)$jadwal->updateJadwal > 0)
				{
					?>
					<td style="border:1px solid #000;padding:5px;text-align:center;font-weight: bold;"><?php echo '09:00 - '.$jadwal->jamSelesai; ?></td>
					<td style="border:1px solid #000;padding:5px;font-weight: bold;"><?php echo $jadwal->mataAjarName; ?></td>
					<td style="border:1px solid #000;padding:5px;text-align:center;font-weight: bold;"><?php $total += (float)$jadwal->jamLat;  echo $jadwal->jamLat; ?></td>
					<?php
				}
				else 
				{
				...
				if($i == $length)
				{
					...
					<tr>
						...
						if((int)$jadwal->updateJadwal > 0)
						{
							...
							<td style="border:1px solid #000;padding:5px;text-align:center;" rowspan="2"><?php echo $jadwal->hari; ?></td>
							<td style="border:1px solid #000;padding:5px;text-align:center;" rowspan="2"><?php echo $jadwal->tanggal; ?></td>
							<td style="border:1px solid #000;padding:5px;text-align:center;font-weight: bold;"><?php echo $jadwal->jamMulai.' - '.$jadwal->jamSelesai; ?></td>
							<td style="border:1px solid #000;padding:5px;font-weight: bold;"><?php echo $jadwal->mataAjarName; ?></td>
							<td style="border:1px solid #000;padding:5px;text-align:center;font-weight: bold;"><?php $total += (float)$jadwal->jamLat; echo $jadwal->jamLat; ?></td>
							<?php
						}
