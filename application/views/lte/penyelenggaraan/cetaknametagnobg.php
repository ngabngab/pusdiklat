					...
					<tr class="txt-footer">
						<td style="width: 335px;padding-top:30px;">
							<div style="border:1px double #000;height:430px;margin-right:3px;margin-bottom: 50px;padding:2px;">
								<div style="border:1px double #000;height:280px;max-height:280px;background-image: url('<?php echo base_url();?>assets/img/nametagnobg.png');background-repeat:no-repeat;background-size:contain;">
									<div style="color:#000;text-align:center;font-size:12pt;margin-top:100px;"><?php echo $kaldikDesc;?></div>
									<div style="color:#000;text-align:center;font-size:10pt;bottom:0px;margin-top:10px;"><?php echo $Tgl;?></div>
								</div>
