...
<?php
		...
		if($sesis)
		{
			...
			{
				?>
				arrSesi.push({'sesiid':'<?php echo $sesi->kurikulumSesiID; ?>', 'startdate':'<?php echo $sesi->startDate; ?>', 'enddate':'<?php echo $sesi->endDate; ?>', 'libur':<?php echo $sesi->libur; ?>, 'minggu':<?php echo $sesi->minggu; ?>, 'hari':<?php echo $sesi->hari; ?>, 'sesiname':'<?php echo $sesi->sesiName; ?>', 'sesino':<?php echo $sesi->sesiNo; ?>,'peserta':<?php echo $sesi->peserta; ?>, 'sesidesc':'<?php echo $sesi->kurikulumSesiDesc; ?>'});
		...
		<div class="col-xs-12">
            ...
            <div class="box-body">
				...
				<div class="col-xs-12">
						...
						<div class="col-xs-12">&nbsp</div>
						<div class="form-group">
							<button type="button" class="btn btn-warning" onclick="ubahKaldik();"><i class="fa fa-pencil"></i> Ubah KALDIK</button>&nbsp&nbsp
