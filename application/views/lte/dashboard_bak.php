...
<div class="wrapper">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo base_url();?>assets/lte/dist/img/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo base_url();?>assets/lte/dist/img/user3-128x128.jpg" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo base_url();?>assets/lte/dist/img/user2-160x160.jpg" alt="user image" class="offline">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016 <a href="http://www.eztudia.com">eztudia</a>.</strong> All rights
    reserved.
  </footer>
