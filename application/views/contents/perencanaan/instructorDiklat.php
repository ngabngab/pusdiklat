            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						echo form_open('instructor/diklat/'.$instructors[0]->pegawaiID, $attributes); ?>
							
							<label>NIP</label>
							<div class="form-group">
								<input class="form-control" type="hidden" id="instructorID" name="instructorID" readonly value="<?php echo $instructors[0]->pegawaiID; ?>">
								<input class="form-control" type="text" id="instructorNIP" name="instructorNIP" readonly value="<?php echo $instructors[0]->pegawaiNIP; ?>">
							</div>
							
							<label>Nama</label>
							<div class="form-group">
								<input class="form-control" type="text" id="instructorName" name="instructorName" readonly value="<?php echo $instructors[0]->pegawaiDegreeFirst." " .$instructors[0]->pegawaiName." ".$instructors[0]->pegawaiDegreeLast; ?>">
							</div>
									...
									if($diklats){
										...
										foreach($diklats as $diklat){
											...
											<tr>
												...
												<a href="<?php echo base_url();?>index.php/instructor/delete/<?php echo $diklat->instructorAssignmentID;?>/<?php echo $diklat->pegawaiID;?>" onclick = "if (! confirm('Are you sure want to delete this?')) { return false; }">hapus</a></td>
											</tr>
											<?php
											$i++;
										}
