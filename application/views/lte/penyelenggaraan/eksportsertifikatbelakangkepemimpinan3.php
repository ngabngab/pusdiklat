...
<table style="width:100%;margin-top:20px;">
	...
	<tr>
		...
		<td style="font-size: 12pt;padding:30px 5px 5px 5px;text-align:center;">'.$diklatLocName.', '.$tglEnd.'</td>
	</tr>
	<tr>
		<td style="font-size: 12pt;padding:5px 5px 5px 20px;">1. Pengembangan Potensi Diri</td>
		<td style="font-size: 12pt;padding:5px 5px 5px 5px;text-align:center;">'.$namaJabatan.'</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="font-size: 12pt;padding:5px 5px 5px 5px;text-align:center;">'.$namaKapus.'</td>
	</tr>
	<tr>
		<td style="font-size: 12pt;padding:5px 5px 5px 20px;">5. Membangun Tim Efektif</td>
		<td style="font-size: 12pt;padding:5px 5px 5px 5px;text-align:center;">NIP '.$nipKapus.'</td>
	</tr></table>
</body>
</html>';
echo $html;
