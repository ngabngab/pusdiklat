...
function cetakKaldik()
{
	var uri = '<?php echo base_url() ?>cetakkaldik/';
	newTab(uri);
}
</script>
      ...
      <div class="row">
		<div class="col-xs-12">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title">Pencarian Data Kaldik : Periode <?php echo $monthName; ?> - <?php echo $thisYear; ?></h3>
		...
		<div class="col-xs-12">
            ...
            <div class="box-header">
              ...
              <div class="box-tools pull-right">
				<button type="button" class="btn btn-primary btn-sm pull-right" data-widget="collapse" data-toggle="tooltip" title="Collapse" style="margin-right: 5px;">
                  <i class="fa fa-minus"></i></button>
                  <button type="button" class="btn btn-primary btn-sm pull-right" style="margin-right: 5px;" onclick="cetakKaldik();">
                  <i class="fa fa-print"></i> Cetak Kaldik</button>
              </div>
            </div>
            ...
            <div class="box-body">
				...
				<div class="dragscroll" style="overflow:scroll;">
									...
									{	
										foreach($kaldik->cal[$i] as $calen)
										{
											...
											if($calen->enddate == '1')
											{
												...
												{
													?>
													<td style="background-color:#<?php echo $kaldik->color; ?>;padding:0!important;text-align:center;"><a href="#" id="<?php echo base_url(); ?>kaldik/viewkaldik/<?php echo $kaldik->kaldikID; ?>/<?php echo $kaldik->startDate; ?>" onclick="viewKaldik(this.id);" data-toggle="tooltip" data-html="true" data-placement="top" title="<?php echo $calen->sesiName."<br>Kurikulum : ".$calen->kurikulumSesiDesc . "<br>Sumber Biaya : " . $kaldik->biayaName . "<br>".$statKaldik; ?>"><div style="margin:0!important;padding:0!important;width:100%;height:100%;display:inline-block;"><?php echo $kaldik->kelas; ?></div></a></td>
													<?php
												}
												else
												{
												?>
													<td style="background-color:#03A9F4;padding:0!important;text-align:center;"><a href="#" id="<?php echo base_url(); ?>kaldik/viewkaldik/<?php echo $kaldik->kaldikID; ?>/<?php echo $kaldik->startDate; ?>" onclick="viewKaldik(this.id);" data-toggle="tooltip" data-html="true" data-placement="top" title="<?php echo $calen->sesiName."<br>Kurikulum : ".$calen->kurikulumSesiDesc . "<br>Sumber Biaya : " . $kaldik->biayaName."<br>".$statKaldik; ?>"><div style="margin:0!important;padding:0!important;width:100%;height:100%;display:inline-block;"><?php echo $kaldik->kelas; ?></div></a></td>
												<?php
												}
											}
					...
					<tfoot>
					<tr>
						<th style="background-color:#FF7043;">&nbsp</th>
						<th style="background-color:#FF7043;">TAMBAH DIKLAT</th>
						<th style="background-color:#FF7043;">&nbsp</th>
						<th style="background-color:#FF7043;">&nbsp</th>
						<?php
						$k = 0;
						foreach($calendars->date as $cal)
						{
							if ($Day[$k] == '7')
							{
								?>
							...
							else
							{
								...
								{
									?>
									<th style="background-color:#FF7043;"><a href="#" id="<?php echo base_url() ?>kaldik/tambahkaldik/<?php echo $cal;?>" onclick="tambahKaldik(this.id, '<?php echo $cal;?>')" data-toggle="tooltip" data-placement="top" title="Tambah Kaldik"><div style="margin:0!important;padding:0!important;width:100%;height:100%;display:inline-block;">&nbsp</div></th>
									<?php
								}
								else
								{
									foreach ($Libur[$k] as $Holiday)
									{
									?>
										<td style="background-color:#F44336;padding:0!important;"><a href="#" data-toggle="tooltip" data-placement="top" title="<?php echo $Holiday->holidayDesc; ?>"><div style="margin:0!important;padding:0!important;width:100%;height:100%;display:inline-block;">&nbsp</div></a></td>
										<?php
									}
								}
							}
