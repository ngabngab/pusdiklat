		...
		<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php 
							...
							echo form_open('Kaldik/realinsert/'.$idRealKaldik, $attributes); 
                    ...
                    <div class="col-lg-6">
                        ...
                        <img src="<?= base_url()?>/assets/img/line.png" style="width: 100%;"/>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kaldikCode" readonly="true" placeholder="Enter Kode Kaldik" value="<?php echo $kaldik[0]->kaldikCode; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kaldikDiklatName" id="namaDiklat" readonly="true" value="<?php echo $kaldikDiklatName; ?>">
                            </div>
                    ...
                    <div id="vDate1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" id="vhari" name="hari" placeholder="Hari" value="<?php echo $kaldik[0]->hari; ?>" readonly="true" style="width: 100px;">
                            </div>
                            <div class="form-group">
                    ...
                    <h4><i class="fa fa-check-square-o"></i> Realisasi Diklat</h4>
                        ...
                        <div class="form-group">
                            <label>Jumlah Peserta Maksimal</label>
                            <input class="form-control" type="number" name="participantLength" placeholder="Peserta" onchange="checkTextField()" value="<?php echo $Realkaldik[0]->participantLength; ?>" style="width: 100px;">
                        </div>
