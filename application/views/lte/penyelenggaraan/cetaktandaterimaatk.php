...
<div id="header">
	...
	<div style="font-size: 12pt;margin-top:10px;">TANDA TERIMA ATK</div>
	<div style="font-size: 10pt;">DIKLAT <?php echo $diklatTypeName; ?></div>
...
<table style="width: 100%;font-size:9pt;">
	<thead>
	<tr>
		<td style="border:1px solid #000;padding:2px;font-weight:bold;">No</td>
		<td style="border:1px solid #000;padding:2px;font-weight:bold;text-align:center;">Nama</td>
		<td style="border:1px solid #000;padding:2px;font-weight:bold;text-align:center;"><?php echo $txtNIP; ?></td>
		<td style="border:1px solid #000;padding:2px;font-weight:bold;text-align:center;">Unit Organisasi</td>
		<td style="border:1px solid #000;padding:2px;font-weight:bold;text-align:center;">Tanda Tangan</td>
	</tr>
	</thead>
	<tbody>
	<?php 
